...
return new class extends Migration {
    ...
    public function up(): void
    {
        Schema::create('transaction_header', function (Blueprint $table) {
            ...
            /**
             * #catatan
             * Pada Diagram ERD di pdf petunjuk pengerjaan seharusnya menggunakan enum,
             * karena tidak memungkinkan menggunakan enum untuk data yang tidak sama dengan yang disediakan di dalam enum
             * maka saya terpaksa menggunakan varchar
             */
            // $table->enum('code', [123456, 1234]);
